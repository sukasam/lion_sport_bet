<?php  
    ...
    $RecDataSum = $db->select("SELECT sum(`amount`) as sumAmount FROM commission_history ORDER BY id DESC");
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Exchange commission (Invite)</h3>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"exchange_commission_ajax.php", // json datasource
