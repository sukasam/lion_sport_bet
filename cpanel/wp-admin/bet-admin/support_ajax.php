...
$query = mysqli_query($conn, $sql) or die("support_ajax.php: get support");
...
while ($row = mysqli_fetch_array($query)) { // preparing an array
    ...
    $nestedData[] = "<i class=\"fa fa-comment\" style=\"color: red;\"></i> " . $smsg;
    $nestedData[] = $row["date"];
    $nestedData[] = $row["time"];
    // $nestedData[] = $row["status"];
    $nestedData[] = "<center class=\"btAction\"><button class=\"btn btn-primary btn-xs\" title=\"Chat\" onClick=\"window.location='support_edit.php?Player=" . $row["player"] . "'\"><i class=\"fa fa-comments-o\"></i></button></center>";
