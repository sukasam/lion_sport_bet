<?php  
    ...
    $RecDataSum = $db->select("SELECT sum(`point`) as sumAmount FROM rank_tophand");
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Summary Top Hand</h3>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"report_tophand_ajax.php", // json datasource
