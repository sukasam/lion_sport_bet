<?php
  ...
  if($_GET['action'] == "submit"){
    ...
    $q = $db->Update('iranian_milioner_history', $array_fields, $array_where);
  ...
  $RecDataDrawHistory = $db->select("SELECT * FROM iranian_milioner_history WHERE id = '".$_GET['id']."'");
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Iranian Milioner Results (Update)</h3>
        <div class="row mt">
          <div class="col-lg-12">
          <div class="form-panel">
              <form class="form-horizontal style-form" method="post" action="iranian_milioner_results_update.php?action=submit">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="ball_numbers" class="form-control" data-inputmask="'mask': '99-99-99-99-99'" value="<?php echo $RecDataDrawHistory[0]['ball_numbers'];?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Lucky Stars</label>
                  <div class="col-sm-10">
                    <input type="text" name="lucky_stars" class="form-control" data-inputmask="'mask': '99-99'" value="<?php echo $RecDataDrawHistory[0]['lucky_stars'];?>">
                  </div>
                </div>
                <div class="form-group">
