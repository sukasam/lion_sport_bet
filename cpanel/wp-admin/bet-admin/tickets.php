<?php  
    ...
    $RecData = $db->select("SELECT * FROM tickets ORDER BY id DESC");
      ...
      <section class="wrapper">
        ...
        <div class="row mb">
          ...
          <div class="content-panel" style="margin-left: 15px;margin-right: 15px;padding-left: 15px;padding-right: 15px;">
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" class="display responsive table table-bordered" id="hidden-table-info" style="width:100%">
                <thead>
                  <tr>
                    <th>TKID</th>
                    <th>Player</th>
