...
$RecDataGameRow = $db->select("SELECT * FROM game_row WHERE id = '" . $_GET['id'] . "' AND `g_row` = '1'");
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Game Row 01 (Edit)</h3>
        <div class="row mt">
          <div class="col-lg-12">
          <div class="form-panel">
              <form class="form-horizontal style-form" method="post" action="game_rowone_edit.php?action=submit" enctype="multipart/form-data">
