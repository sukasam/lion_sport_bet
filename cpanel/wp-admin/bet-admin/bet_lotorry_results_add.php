<?php
  ...
  if(isset($_GET['action']) && $_GET['action'] === "submit"){
    ...
    $bet_lotorry_jackpot = $db->CleanDBData($_POST['bet_lotorry_jackpot']);
    
    $insert_arrays = array(
      'bet_lotorry_jackpot'=> $bet_lotorry_jackpot, 
      'bet_lotorry_date'=> $dateA, 
      'date_create'=> $db->CleanDBData(date("Y-m-d")),
      'time_create'=> $db->CleanDBData(date("H:i:s")),
    );
    
    $result_id  = $db->insert('bet_lotorry_history',$insert_arrays);
      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          ...
          <div class="form-panel">
              <form class="form-horizontal style-form" method="post" action="bet_lotorry_results_add.php?action=submit">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Date</label>
                  <div class="col-sm-10">
                  <?php 
                   $date = date_create($RecData[0]['lotorry_close']);
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="text" value="<?php echo $RecData[0]['lotorry_per_jackpot'];?>" readonly>
                    <input name="bet_lotorry_jackpot" type="hidden" class="form-control" value="<?php echo $RecData[0]['lotorry_per_jackpot'];?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-12">
                  <table class="table table-betlotorry">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $i+1;?></td>
                        <td><input type="text" name="bethome[]" class="form-control" value="" required></td>
                        <td><input type="radio" name="betresults[<?php echo $i;?>]" value="1" disabled></td>
                        <td><input type="radio" name="betresults[<?php echo $i;?>]" value="2" disabled></td>
                        <td><input type="radio" name="betresults[<?php echo $i;?>]" value="3" disabled></td>
                        <td><input type="text" name="betaway" class="form-control" value="" required></td>
                      </tr>
                      <?php
                      }
                      ?>
