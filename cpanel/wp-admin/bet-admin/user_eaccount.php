  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> User Account <i class="fa fa-angle-right"></i> Email Active Users</h3>
        <div class="row mb">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $( ".udelBt" ).click(function() {
        ...
        window.location.href = 'user_eaccount.php?action=delete&user='+player;
      });
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"user_eaccount_ajax.php", // json datasource
