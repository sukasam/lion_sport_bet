...
if ($_GET['action'] == 'delete') {
    ...
    $ql = $db->Delete('guide', $array_where);
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Guide</h3>
        <div><a href="guide_add.php"><button class="btn btn-primary">Add Guide</button></a></div></div><br>
        <div class="row mb">
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          Are you sure you want to delete this guide (<span id="guideName"></span>)?
          <span id="guideID" class="hide"></span>
          </div>
  ...
  function deleteGame(id,name,img){
    ...
    $(document).ready(function() {
      ...
      $( ".udelBt" ).click(function() {
        var id = $("#guideID").text();
        window.location.href = 'guide.php?action=delete&id='+id;
      });
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"guide_ajax.php", // json datasource
