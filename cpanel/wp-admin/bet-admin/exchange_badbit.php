<?php  
    ...
    $RecDataSum = $db->select("SELECT sum(`point`) as sumAmount FROM point_history WHERE point_type = 'top_lost'");
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Exchange point (Bad Bit)</h3>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"exchange_badbit_ajax.php", // json datasource
