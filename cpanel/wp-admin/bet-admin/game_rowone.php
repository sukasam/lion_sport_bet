...
if (isset($_GET['action']) && $_GET['action'] === 'delete') {
    ...
    $ql = $db->Delete('game_row', $array_where);

    unlink(ROOTGAMEIMG.'game/'.$_GET['img']);
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Game Row 01</h3>
        <div><a href="game_rowone_add.php"><button class="btn btn-primary">Add Game Row 01</button></a></div></div><br>
        <div class="row mb">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Delete Game Row 01</h4>
          </div>
          <div class="modal-body">
          Are you sure you want to delete this game (<span id="gameName"></span>)?
          <span id="gameID" class="hide"></span>
          <span id="gameIMG" class="hide"></span>
          </div>
...
<script src="js/jquery.dataTables.min.js"></script>
  ...
  function deleteGame(id,name,img){
    $("#gameName").text(name);
    $("#gameIMG").text(img);
    $("#gameID").text(id);
    $("#myModal").modal('show');
    ...
    $(document).ready(function() {
      ...
      $( ".udelBt" ).click(function() {
        var id = $("#gameID").text();
        var img = $("#gameIMG").text();
        window.location.href = 'game_rowone.php?action=delete&id='+id+'&img='+img;
      });
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"game_rowone_ajax.php", // json datasource
