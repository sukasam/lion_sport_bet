...
if (isset($_GET['action']) && $_GET['action'] === "submit") {
    ...
    header("Location:user_eaccount.php");
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> User Account <i class="fa fa-angle-right"></i> Email Active Users <i class="fa fa-angle-right"></i> (Edit -> <?php echo $_GET['Player']; ?>)</h3>
        <div class="row mt">
          <div class="col-lg-12">
          <div class="form-panel">
              <form class="form-horizontal style-form" method="post" action="user_eaccount_edit.php?action=submit">
    ...
    ?>
                ...
                <div class="form-group">
                  ...
                  <button class="btn btn-theme04" type="button" onClick="window.location='user_eaccount.php';">Cancel</button>
                  </div>
                </div>
