  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Financial <i class="fa fa-angle-right"></i> Today Deposit (PM) | <?php echo $dateToday;?> </h3>
        <div class="row mb">
              ...
              <table cellpadding="0" cellspacing="0" class="display responsive table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="text-center">Transaction Codes</th>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"deposit_pm_ajax.php", // json datasource
