  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Game Row 02</h3>
        <div><a href="game_rowtwo_add.php"><button class="btn btn-primary">Add Game Row 02</button></a></div></div><br>
        <div class="row mb">
  ...
  function deleteGame(id,name,img){
    ...
    $(document).ready(function() {
      ...
      $( ".udelBt" ).click(function() {
        ...
        window.location.href = 'game_rowtwo.php?action=delete&id='+id+'&img='+img;
      });
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"game_rowtwo_ajax.php", // json datasource
