  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Financial <i class="fa fa-angle-right"></i> Pending Withdraw | <?php echo $dateToday; ?> </h3>
        <div class="row mb">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"pending_withdraw_ajax.php", // json datasource
