...
$conn = mysqli_connect($db_conn['host'], $db_conn['user'], $db_conn['pass'], $db_conn['database']) or die("Connection failed: " . mysqli_connect_error());
 ...
 $sql = "SELECT *";
 $sql.=" FROM deposit_history WHERE deposit_type = 'E-Voucher'";
 $query=mysqli_query($conn, $sql) or die("deposit_ajax.php: get deposit_history");
 ...
 while( $row=mysqli_fetch_array($query) ) {  // preparing an array
   ...
   $nestedData[] = number_format($row["amount"] * $row['currency']);
