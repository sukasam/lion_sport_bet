<?php
      $url = "http://".$_SERVER['SERVER_NAME'].":2082/lionroyalapi";  // put your API path here
      ...
      define('PATH_SITE','/lionroyal_bet');
      define('API_SITE',DOMAIN_SITE.PATH_SITE.'/statics/api.php');

      define('SCRIPT_AUTO_SITE',DOMAIN_SITE.PATH_SITE.'site/statics/api.php');
