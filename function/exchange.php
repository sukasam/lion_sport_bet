    ...
    if($csrf->check_valid('post')) {
        if($_POST){
            ...
            if($_GET['ref'] == "1"){
                ...
                $point = preg_match(',', '', $db->CleanDBData($_POST["point_tophand"]));
                ...
                $point = preg_match(',', '', $db->CleanDBData($_POST["point_topwin"]));
                ...
                $point = preg_match(',', '', $db->CleanDBData($_POST["point_toplost"]));
