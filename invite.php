<?php
	...
	$affiliate = DOMAIN_SITE."/register.php?affiliate=".$ketInvite;
			...
			<section class="feature-area section-gap " id="invite">
				<div class="container card-content">
                    <?php if($RecDataUser[0]['inviteUser'] == 1){
						...
						<table id="tickets" class="table table-striped table-bordered display responsive nowrap" style="width: 100%;">
                            <thead>
								<tr>
									<th>#</th>
                        ...
                        <div class="col-12 text-center">
                            <h3 class="text-heading"><?php echo INVITE_TOTAL_COMMISTION;?> : <span class="spanO"><?php echo number_format($someCom);?></span> <?php echo TITLE_TOMAN;?></h3>
                        </div>
