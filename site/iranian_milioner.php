                        ...
                        <div class="col-12">
                            <div class="row mgL0 mgR0">
                                ...
                                <div class="col-12 col-md-8 colRight pdB30">
                                    <form name="irnumber" id="irnumber" action="iranian_milioner.php?action=saveNumbers" method="post" onkeydown="return event.key != 'Enter';">
                                    <div class="row">
                                            ...
                                            <div>
                                                ...
                                                for($i=1;$i<=$configDT[0]['per_lines'];$i++){
                                                    ...
                                                    <ul class="drowNum">
                                                        ...
                                                        <li><button class="genric-btn default arrow mb-10 btLuckDip" onclick="cancelLuckDip(<?php echo $i;?>);" type="button"><span style="padding-right: 10px;">X</span></button></li>
                                                    </ul>
