...
<html>
    ...
    <iframe src="http://<?php echo $_SERVER['SERVER_NAME']?>:8080/?LN=<?php echo $_SESSION['Player'];?>&SK=<?php echo $key;?>" frameborder="0" style="overflow:hidden;height:100%;width:100%" height="100%" width="100%"></iframe>
</body> 
</html>
