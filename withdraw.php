...
<!DOCTYPE html>
    ...
    body{
				...
				<div class="container card-content">					
                    <div class="row">
                        <div class="col-12 mb-20">
                            <h3 class="text-heading"><?php echo TOP_MENU_WITHDRAW_EV;?></h3> 
                        </div>
                        <?php
                        ...
                        <div class="col-12 mb-40">
                            <form id="frm_deposit" name="frm_deposit" action="withdraw.php?action=withdraw" method="post">
                            <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="text-center">
                                ...
                                <input type="hidden" name="withdraw_type" id="withdraw_type" value="1">
                            ...
                            ?>
                            <div class="col-12 mb-40">
                                <div class="text-center onlineCard"><br><?php echo TITLE_WITHDRAW_EV_CARD;?><br><br>
        ...
        function packageAmount(amount){
           $("#amount").val(amount);
           if(amount == "3000000"){$(".pkamount").html("3 MIL");}
           if(amount == "2000000"){$(".pkamount").html("2 MIL");}
           if(amount == "1500000"){$(".pkamount").html("1.5 MIL");}
           if(amount == "1000000"){$(".pkamount").html("1 MIL");}
           if(amount == "750000"){$(".pkamount").html("750K");}
